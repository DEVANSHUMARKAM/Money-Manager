...
import in.devanshu.moneymanager.repository.CategoryRepository;
import in.devanshu.moneymanager.repository.IncomeRepository;
...
public class IncomeService {
    ...
    //Retrives all incomes for current month/based on the start date and end date
